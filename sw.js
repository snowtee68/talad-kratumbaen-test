const CACHE_NAME = 'talad-kratumbaen-v0.5.22.146-location-help-locmap147';
const IMAGE_CACHE_NAME = 'talad-supabase-public-images-v1';
const CORE = [
  './',
  './index.html',
  './styles.css',
  './app.js?v=0.5.22.144-r1',
  './manifest.webmanifest',
  './icons/icon-192.png?v=0.5.22.136-r1',
  './icons/icon-512.png?v=0.5.22.136-r1',
  './icons/icon-maskable-512.png?v=0.5.22.136-r1',
  './icons/apple-touch-icon.png?v=0.5.22.136-r1'
];
